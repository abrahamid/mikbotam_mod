...
$mkbot->cmd('/start|/Start', function () {
      ...
      if (has($idtelegram) == false) {
         ...
         $text    = 'Selamat datang di portal pembelian voucer EZ_Net \nklik /daftar untuk mendaftarkan akun telegram anda,\nlalu ketika "/deposit 5000" untuk emndapatkan saldo 5000 bagi yang baru mendaftar;a;u ketikan';
         $options = [
            'parse_mode' => 'html'
         ];
