...
class Bot {
    ...
    public static function send($action = 'sendMessage', $data = []) {
        ...
        $needChatId = ['sendMessage', 'sendAnimation', 'forwardMessage', 'sendPhoto', 'sendAudio', 'sendDocument', 'sendSticker', 'sendVideo', 'sendVoice', 'sendLocation', 'sendVenue', 'sendContact', 'sendChatAction', 'editMessageText', 'editMessageCaption', 'editMessageReplyMarkup', 'sendGame', 'deleteMessage', 'restrictChatMember', 'pinChatMessage', 'getChatAdministrators', ];
